...
const (
	binaryName   = "import-tiingo"
	packageName  = "."
	noGitLdflags = "-X github.com/penny-vault/import-tiingo/common.buildDate=$BUILD_DATE"
)

var ldflags = "-X github.com/penny-vault/import-tiingo/common.commitHash=$COMMIT_HASH -X github.com/penny-vault/import-tiingo/common.buildDate=$BUILD_DATE"
